...
<div class="escritorios index">
	<h2><?php __('Escritórios');?></h2>
	...
	<tr<?php echo $class;?>>
		...
		<td><?php echo $escritorio['Escritorio']['nome']; ?>&nbsp;</td>
		<td class="actions">
			<?php echo $this->Html->link(__('Edit', true), array('action' => 'edit', $escritorio['Escritorio']['id'])); ?>
			<?php echo $this->Html->link(__('Excluir', true), array('action' => 'delete', $escritorio['Escritorio']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $escritorio['Escritorio']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
