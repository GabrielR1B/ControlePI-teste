	...
	<?php if (!empty($inventores)): ?>
		...
		<?php endif; ?>
			...
			<tr<?php echo $class;?>>
				...
				<td>
					<p><?php echo $inventor['nome']; ?></p>
				</td>
				<td width="100"><center><?php echo $inventor['tecnologias']; ?></center></td>
				<td class="actions">
					<?php echo $this->Html->link(__('View', true), array('action' => 'view', $inventor['id'])); ?>
					<?php echo $this->Html->link(__('Edit', true), array('action' => 'edit', $inventor['id'])); ?>
				</td>
			</tr>
			<?php endforeach; ?>
